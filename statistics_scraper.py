...
print_data_financial_annual = []
print_data_financial_quarterly = []

def finance_scraper_annual(stock):

    url = 'https://stockanalysis.com/stocks/' + stock + '/financials/'
...
def finance_scraper_quarterly(stock):

    url = 'https://stockanalysis.com/stocks/' + stock + '/financials/quarterly/'
...
def finish():
    ...
    print_data_financial_annual.append(finance_scraper_annual('AMD'))
    print_data_financial_quarterly.append(finance_scraper_quarterly('AMD'))
    ...
    with open('financeAnnualIncomeData.json', 'w') as f:
        json.dump(print_data_financial_annual, f)
    
    with open('financeQuarterlyIncomeData.json', 'w') as f:
        json.dump(print_data_financial_quarterly, f)
